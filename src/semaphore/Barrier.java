...
public class Barrier {
    ...
    public void waitForOthers() throws InterruptedException {
        ...
        if (isLastWorker) {
            ...
            System.out.printf("All worker threads have completed part1 of the task, " +
                    "released %s number of permits, blocking threads will continue now.", numberOfWorkers - 1);
        } else {
            semaphore.acquire();
        }
    }
