...
public class MatricesGenerator {
    private static final String OUTPUT_FILE = "./out/matricesMultiplier/matrices.txt";
    ...
    private static void saveMatrixToFile(FileWriter fileWriter, float[][] matrix) throws IOException {
        writeToFile(fileWriter, matrix, N);
    }

    static void writeToFile(FileWriter fileWriter, float[][] matrix, int n) throws IOException {
        for (int r = 0; r < n; r++) {
